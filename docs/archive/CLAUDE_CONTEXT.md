...
Repositório: https://github.com/reigrotti/routiq-engine

## Stack
Next.js 14, Node 22, Prisma 7.7.0, PostgreSQL 15, Cloud SQL (GCP), VGS, ChromeOS Penguin + VS Code

## Infraestrutura GCP
- Projeto: routiq-serverless-mvp
- Instância Cloud SQL: routiq-serverless-mvp:southamerica-east1:routiq-db-instance
...
~/cloud-sql-proxy --port 5432 routiq-serverless-mvp:southamerica-east1:routiq-db-instance

Aba 2 — Servidor:
cd ~/routiq-engine && npm run dev
...
2. Deploy Cloud Run:
   gcloud run deploy routiq \
     --source . \
     --region southamerica-east1 \
     --add-cloudsql-instances routiq-serverless-mvp:southamerica-east1:routiq-db-instance \
...
- VS Code abre com: code ~/routiq-engine
...
- **Cloud Run URL:** https://routiq-engine-728639463419.southamerica-east1.run.app
- **Checkout:** https://routiq-engine-728639463419.southamerica-east1.run.app/checkout
...
- **Cloud Run URL:** https://routiq-engine-728639463419.southamerica-east1.run.app
- **Conector Cloud SQL:** Unix Socket (Instância: routiq-db-instance)
